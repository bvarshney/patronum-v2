    ...
    return (
        <>
            ...
            <PageLayout
                ...
                description={"Patronum simplifies email signature management for Google Workspace with centrally managed Gmail email signatures without the hassle of complex settings."}
