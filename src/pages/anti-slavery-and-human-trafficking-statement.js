    ...
    return (
        <>  
            <MetaData 
                ...
                description={"This statement provides the steps Bespin Labs Limited have taken and continue to take to minimize the risk of modern slavery and human trafficking in its business and supply chain and is published in line with section 54(1) of the Modern Slavery Act 2015."}
                    ...
                    <div className="container">
                        <div className="content-2">
                            ...
                            <div className={styles.policy}>
                                ...
                                take to minimize the risk of modern slavery and human trafficking in its business 
