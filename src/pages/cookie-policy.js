                    ...
                    <div className="container">
                        <div className="content-2">
                            ...
                            <div className={styles.policy}>
                                <p>This website <a href="http://www.patronum.io" target="_blank" rel="noopener">www.patronum.io</a> is operated by Bespin Labs Limited (“we”, “us”, “our”).</p>
                                <p>Like many other websites, this website uses cookies. This policy explains the way in which cookies are used on our website. Please ensure you have read and understood this policy before continuing to use our website. If you have any questions about our use of cookies, you can contact us at privacy@patronum.io</p>
                                <h3 className="wp-block-heading"><span lang="EN-GB">1. WHAT ARE COOKIES?</span></h3>
                                <p>Cookies are text files containing small amounts of information which are downloaded to your device when you visit a website. Cookies are then sent back to the originating website on each subsequent visit, or to another website that recognises that cookie. Cookies are useful because they allow a website to recognise a user’s device. You can find more information about cookies at: www.allaboutcookies.org and <a href="http://www.youronlinechoices.eu" target="_blank" rel="noopener">www.youronlinechoices.eu</a>.</p>
                                ...
                                <h3 className="wp-block-heading"><span lang="EN-GB">2. WHICH COOKIES ARE USED ON THIS WEBSITE?</span></h3>
                                <p>The cookies used on this website have been categorised based on the categories found in the ICC UK Cookie guide.</p>
                                <p>A list of all the cookie types used on this website by category is set out below.</p>
                                <h4 className="wp-block-heading"><span lang="EN-GB">2.1 Strictly necessary cookies</span></h4>
                                <p>These cookies are essential in order to enable you to move around the website and use its features, such as accessing secure areas of the website. Without these cookies, services you have asked for cannot be provided.</p>
                                <h4 className="wp-block-heading">2.2 <span lang="EN-GB">Performance cookies</span></h4>
                                <p>These cookies collect information about how visitors use a website, for instance which pages visitors go to most often, and if they get error messages from web pages. These cookies don’t collect information that identifies a visitor. All information these cookies collect is aggregated and therefore anonymous. It is only used to improve how a website works.</p>
                                <h4 className="wp-block-heading">2.3 <span lang="EN-GB">Functional cookies</span></h4>
                                ...
                                <h3 className="wp-block-heading"><span lang="EN-GB">3. HOW CAN THE COOKIES BE REMOVED?</span></h3>
                                <p>You may refuse to accept cookies by activating the setting on your internet browser which allows you to refuse the setting of cookies. For more information about cookies including how to set your internet browser to reject cookies please go to www.allaboutcookies.org. To opt out of Google Analytics visit <a href="http://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener">http://tools.google.com/dlpage/gaoptout</a>.</p>
                                <figure className="wp-block-table is-style-regular">
                                    <table className="cookie-table">
                                        <tbody>
                                            <tr>
                                                <th className="small">Cookies</th>
                                                <th>Purpose</th>
                                            </tr>
                                            <tr>
                                                <td style={{textAlign:"center"}}>Google Analytics</td>
                                                <td>Google Analytics&nbsp;is a web analysis service offered by&nbsp;Google&nbsp;Inc. (Google).&nbsp;Google&nbsp;places the&nbsp;cookies&nbsp;and uses aggregated statistical information from these&nbsp;cookies&nbsp;to provide Bespin Labs with an understanding of how website visitors are using the Websites.</td>
                                            </tr>
                                            <tr>
                                                <td style={{textAlign:"center"}}>Google Tag Manager</td>
                                                <td>Google Tag Manager &nbsp;is a web analysis service offered by&nbsp;Google&nbsp;Inc. (Google). Tag&nbsp;management systems such as&nbsp;Google Tag Manager&nbsp;make it easy for website owners to organize how their sites use&nbsp;cookies.</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </figure>
