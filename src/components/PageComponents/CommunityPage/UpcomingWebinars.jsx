                ...
                <div className="content-2 ">
                    ...
                    <div className='lg:space-y-[0.5vw] space-y-[3vw]'>
                        ...
                        <div
                            ...
                            className='h-full w-full rounded-[0.8vw] duration-200 overflow-hidden fadeUp hover:shadow-xl border hover:border-2 border-[#e8e8e8] hover:border-primary cursor-pointer'
                        >
                            <div className='block w-full h-full'>
                                <Image
                                    quality={100}
                                    src={"/assets/community/upcoming-webinar-new.png"}
                        ...
                        >
                            <div className='h-full w-full rounded-[0.8vw] border border-[#E8E8E8] bg-white hover:border-primary hover:border-2 flex flex-col lg:items-center lg:justify-center lg:text-center lg:py-[1vw] lg:space-y-[1vw] fadeUp lg:px-0 py-[5vw] px-[5vw] space-y-[5vw] duration-200 hover:shadow-xl'>
                                <p className='lg:text-[1.8vw] lg:w-[60%] aeonik font-normal text-[6.5vw] md:text-[4.5vw]'>
                                    Google Workspace Hangout - From Legacy to Google Voice : Transforming Enterprise Telephony
                                </p>
                                <p className='content-p text-[#666666]'>September 18,  4:00 pm</p>
                            </div>
                        </div>
                    </div>
                </div>
